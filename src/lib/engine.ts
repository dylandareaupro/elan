...
// Snapshot du tag #funny récupéré le 2026-06-22. Tu peux coller tes propres
// liens (URL complète ou ID). Note : certaines vidéos peuvent être supprimées
// ou non-intégrables au fil du temps → on tombe alors sur la suivante.
export const TIKTOK_HOLD_VIDEOS: string[] = [
  "7654282623321263378", "7654280662744075542", "7654282514260905238", "7654278523728792854",
  "7654280200351386902", "7654279384949443847", "7654280210501618951", "7654280547824389398",
  "7654281886910598422", "7654280854763621664", "7654283108132441347", "7654279279278083350",
  "7654061569864748310", "7654280833380977933", "7654281260642209032", "7654282564454092054",
  "7654106872886168855", "7654281065657273631", "7654285012925287702", "7654279281610067208",
  "7654285844798295318", "7654061929064860950", "7654281777997171990", "7654280916277169430",
  "7654281862591958294", "7654285105346956566", "7654280080666922262", "7654144999923256589",
  "7654281540699966751", "7654282450767531297", "7653767585770523925", "7654284654471564565",
  "7205261724600175918", "7607734205312781584", "7652662939106790673", "7653848119339257110",
  "7654282134349171990", "7493542442684239126", "7256995378413849899", "7654282547437915422",
  "7654284385105038622", "7654282344597163294", "7654280562894572813", "7654282691159788813",
  "7654282313315978510", "7654281909106740510", "7654285260930174222", "7654286086394449165",
  "7223457824469290245", "7095724233031994670", "7094601122446527790", "7229733032238927147",
  "7513225422885113130", "7445873205652294955", "7515996406272970030", "7486741720873422122",
  "7463545685602749718", "7490960620863376682", "7481328890812697887", "7578145887839440129",
  "7491247703553314090", "7565172760029302032", "7609213239641001217", "7277422720424365345",
  "7245864922674892037", "7332055410163109152", "7654062719494016278", "7275318317756337441",
  "7276802362910526753", "7654324418990083360", "7654283992975346974", "7375504146939546912",
  "7654317482622061838", "7473572785969990914", "7484347412270566678", "7171205692823751982",
  "7654321375603166486", "7654281406385868054", "7654284009697987862", "7654319866991725846",
  "7654283839900060941", "7653507307250191638", "7654282969363795222", "7284229544913931550",
  "7491244386706115862", "7654286134779874573", "7280235644998208801", "7192434726202887466",
  "7257562902742240555", "7492067165416230190", "7483789222915214622", "7612187200175852816",
  "7481007059039784214", "7319575509120159008", "7485034669545704747", "7276259110117510432",
  "7094490475977116974", "7449507518365158686", "7107638823382945070", "7486940670859676950",
];
...
/* Renvoie l'ID TikTok suivant sans répétition : on mélange la liste une fois
   ...
   tout vu — donc on ne revoit pas les mêmes vidéos dans le même ordre. */
function shuffle<T>(arr: T[]): T[] {
  const a = arr.slice();
  for (let i = a.length - 1; i > 0; i--) { const j = Math.floor(Math.random() * (i + 1)); [a[i], a[j]] = [a[j], a[i]]; }
  return a;
}
export function nextTikTokId(): string {
  const ids = tiktokIds();
  if (!ids.length) return "";
  let st = storageGet<{ order: string[]; i: number }>("tiktokCursor", { order: [], i: 0 });
  const samePool = st.order.length === ids.length && st.order.every((x) => ids.includes(x));
  if (!samePool || st.i >= st.order.length) st = { order: shuffle(ids), i: 0 };
  const id = st.order[st.i];
  storageSet("tiktokCursor", { order: st.order, i: st.i + 1 });
  return id;
}
